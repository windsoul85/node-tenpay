...
class Payment {
  ...
  async _request(params, type, cert = false) {
    ...
    console.log("### _request type ### ",type);
    // 安全签名
    ...
    console.log("#### request pkg data",pkg.data);
    this.log('post data =>\r\n%s\r\n', pkg.data);
    ...
    this.log('receive data =>\r\n%s\r\n', data);
     ...
     console.log("### _request data111 ### ",data);
     console.log("### _request type222 ### ",type);

    return ['downloadbill', 'downloadfundflow','unifiedorder'].indexOf(type) < 0 ? this._parse(data, type) : data;
  }
  ...
  unifiedOrder(params) {
    ...
    console.log("### req unifiedOrder pkg ##",pkg);
